...
(0, node_test_1.default)("buildDashboardKpiPresentationItems keeps the visible KPI strip to four ordered cards", () => {
    ...
    strict_1.default.deepEqual(items.map((item) => item.key), ["possible-loss", "recoverable-value", "risky-products", "tasks-today"]);
});
(0, node_test_1.default)("buildDashboardKpiPresentationItems excludes net saved value and keeps tasks visible", () => {
    const dashboardData = (0, dashboardData_1.getDashboardData)("ganjlik");
    const items = (0, dashboardKpiPresentation_1.buildDashboardKpiPresentationItems)(dashboardData);
