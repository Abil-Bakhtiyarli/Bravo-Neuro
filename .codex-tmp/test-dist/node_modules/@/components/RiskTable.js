                                    ...
                                    return ((0, jsx_runtime_1.jsxs)("tr", { tabIndex: 0, "aria-selected": isSelected, "data-selected": isSelected ? "true" : "false", className: (0, utils_1.cn)("group cursor-pointer outline-none transition-transform duration-200 hover:-translate-y-0.5 focus-visible:-translate-y-0.5", isSelected && "translate-y-[-1px]"), onClick: () => onSelectProduct(row.productId), onKeyDown: (event) => {
                                            if (event.key === "Enter" || event.key === " ") {
                                                ...
                                                onSelectProduct(row.productId);
                                                    ...
                                                    ? "border-foreground/30 bg-accent/80"
                                                    : "border-border/75 bg-background/85 group-hover:bg-background"), children: (0, jsx_runtime_1.jsxs)("div", { className: "space-y-1", children: [(0, jsx_runtime_1.jsx)("p", { className: (0, utils_1.cn)("text-sm font-medium", getExpiryTone(row.daysUntilExpiry)), children: formatExpiry(row.daysUntilExpiry) }), (0, jsx_runtime_1.jsx)("p", { className: "text-xs text-muted-foreground", children: "Priority window for intervention" })] }) }), (0, jsx_runtime_1.jsx)("td", { className: (0, utils_1.cn)("border-y px-3 py-4 shadow-[0_12px_30px_-28px_rgba(15,23,42,0.8)] transition-colors duration-200", isSelected
                                                    ? "border-foreground/30 bg-accent/80"
                                                    ...
                                                    ? "border-foreground/30 bg-accent/80"
                                                    : "border-border/75 bg-background/85 group-hover:bg-background"), children: (0, jsx_runtime_1.jsxs)("div", { className: "flex min-w-[16rem] flex-col gap-2", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between gap-3", children: [(0, jsx_runtime_1.jsx)("span", { className: (0, utils_1.cn)("inline-flex rounded-full border px-2.5 py-1 text-[11px] font-semibold uppercase tracking-[0.18em]", action.badge), children: action.label }), (0, jsx_runtime_1.jsx)("span", { className: "text-xs font-medium uppercase tracking-[0.16em] text-muted-foreground", children: "Live signal" })] }), (0, jsx_runtime_1.jsx)("p", { className: "text-sm leading-6 text-foreground/80", children: row.recommendationSummary }), (0, jsx_runtime_1.jsxs)("p", { className: "text-xs font-medium text-muted-foreground", children: ["Net recovery signal ", formatCurrency(row.netSavedValueAzN)] })] }) })] }, `${row.branchId}:${row.productId}`));
                                }) })] }), rows.length === 0 ? ((0, jsx_runtime_1.jsx)("div", { className: "px-4 py-10 text-center text-sm text-muted-foreground", children: "No products match the current search and risk filters." })) : null] })] }));
}
