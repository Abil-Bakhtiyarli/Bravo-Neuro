...
function ProductRiskDrawer({ detail, open, onOpenChange, }) {
    return ((0, jsx_runtime_1.jsx)(dialog_1.Dialog.Root, { open: open, onOpenChange: onOpenChange, children: (0, jsx_runtime_1.jsxs)(dialog_1.Dialog.Portal, { children: [(0, jsx_runtime_1.jsx)(dialog_1.Dialog.Backdrop, { className: "fixed inset-0 z-40 bg-slate-950/52 backdrop-blur-[4px]" }), (0, jsx_runtime_1.jsx)(dialog_1.Dialog.Popup, { className: "fixed inset-0 z-50 flex items-center justify-center p-3 outline-none sm:p-6 xl:p-8", onClick: (event) => {
                        if (event.target === event.currentTarget) {
                            onOpenChange(false);
                        }
                    }, children: detail ? (0, jsx_runtime_1.jsx)(ProductRiskDrawerContent, { detail: detail }) : null })] }) }));
}
