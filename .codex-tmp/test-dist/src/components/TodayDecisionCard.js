...
function TodayDecisionCard({ primaryTask, fallbackRiskRow, detail, onOpenProduct, }) {
    ...
    const netSavedValue = detail?.savings?.netSavedValueAzN ??
        ...
        0;
    return ((0, jsx_runtime_1.jsxs)("section", { className: "animate-demo-fade-up animate-demo-delay-1 rounded-3xl border border-emerald-200/80 bg-[linear-gradient(180deg,rgba(236,253,245,0.9),rgba(255,255,255,0.98))] p-5 shadow-[0_20px_60px_-40px_rgba(5,150,105,0.45)] sm:p-6", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-wrap items-start justify-between gap-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "min-w-0", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-xs font-semibold uppercase tracking-[0.18em] text-emerald-800", children: "Today's AI decision" }), (0, jsx_runtime_1.jsx)("h2", { className: "mt-3 text-2xl font-semibold tracking-tight text-foreground", children: productName }), (0, jsx_runtime_1.jsx)("p", { className: "mt-3 max-w-2xl text-sm text-foreground/80", children: summary })] }), actionMeta ? ((0, jsx_runtime_1.jsxs)("span", { className: (0, utils_1.cn)("inline-flex items-center gap-2 rounded-full border px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.16em]", actionMeta.badge), children: [(0, jsx_runtime_1.jsx)(ActionIcon, { className: "size-4" }), actionMeta.label] })) : null] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-5 grid gap-3 sm:grid-cols-2", children: [(0, jsx_runtime_1.jsxs)("div", { className: "rounded-2xl border border-border/70 bg-background/90 p-4", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-[11px] font-semibold uppercase tracking-[0.16em] text-muted-foreground", children: "Risk level" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-2 text-lg font-semibold capitalize text-foreground", children: riskLevel })] }), (0, jsx_runtime_1.jsxs)("div", { className: "rounded-2xl border border-border/70 bg-background/90 p-4", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-[11px] font-semibold uppercase tracking-[0.16em] text-muted-foreground", children: "Expected net saved" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-2 text-lg font-semibold text-foreground", children: formatCurrency(netSavedValue) })] })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-emerald-200/80 pt-5", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-sm text-foreground/70", children: "Open the full proof and confirm the next move." }), (0, jsx_runtime_1.jsxs)(button_1.Button, { type: "button", onClick: () => onOpenProduct(productId), children: ["View product", (0, jsx_runtime_1.jsx)(lucide_react_1.ChevronRight, { className: "size-4" })] })] })] }));
}
