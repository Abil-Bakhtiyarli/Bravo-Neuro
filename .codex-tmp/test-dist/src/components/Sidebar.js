...
function Sidebar({ pathnameOverride }) {
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "border-b border-border/70 bg-background/90 px-4 py-3 backdrop-blur lg:hidden", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between gap-3", children: [(0, jsx_runtime_1.jsxs)("div", { className: "min-w-0", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-sm font-semibold tracking-[0.18em] text-foreground", children: "BRAVO NEURO" }), (0, jsx_runtime_1.jsx)("p", { className: "text-xs text-muted-foreground", children: "AI Retail Waste Control" })] }), (0, jsx_runtime_1.jsx)("span", { className: "rounded-full border border-emerald-200 bg-emerald-50 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-emerald-800", children: "Live" })] }), (0, jsx_runtime_1.jsx)("nav", { className: "-mx-1 mt-3 flex gap-2 overflow-x-auto px-1 pb-1", children: navItems.map((item) => ((0, jsx_runtime_1.jsx)(NavLink, { item: item, mobile: true, pathnameOverride: pathnameOverride }, item.href))) })] }), (0, jsx_runtime_1.jsx)("aside", { className: "hidden w-64 shrink-0 border-r border-border/70 bg-sidebar/96 lg:flex lg:h-screen lg:flex-col", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex h-full flex-col px-5 py-6", children: [(0, jsx_runtime_1.jsxs)("div", { className: "border-b border-border/70 pb-5", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-sm font-semibold tracking-[0.22em] text-foreground", children: "BRAVO NEURO" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-2 text-sm leading-6 text-muted-foreground", children: "AI Retail Waste Control" })] }), (0, jsx_runtime_1.jsx)("nav", { className: "mt-5 flex flex-1 flex-col gap-1.5", children: navItems.map((item) => ((0, jsx_runtime_1.jsx)(NavLink, { item: item, pathnameOverride: pathnameOverride }, item.href))) }), (0, jsx_runtime_1.jsxs)("div", { className: "border-t border-border/70 pt-5", children: [(0, jsx_runtime_1.jsxs)("div", { className: "rounded-3xl border border-emerald-200/80 bg-emerald-50/85 p-4", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-800", children: "Live snapshot" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-2 text-sm leading-6 text-emerald-950/85", children: "Overview, risk, actions, and branches stay in one branch context." })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-4 rounded-3xl border border-border/75 bg-background/92 p-4", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground", children: "Session" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-2 text-sm font-medium text-foreground", children: "Hackathon build" })] })] })] }) })] }));
}
