...
const navItems = [
    ...
    { label: "Transfers", href: "/transfers", icon: lucide_react_1.ArrowRightLeft },
    { label: "Revenue Forecast", href: "/forecast", icon: lucide_react_1.TrendingUp },
...
function Sidebar({ pathnameOverride }) {
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "border-b border-border/90 bg-sidebar/94 px-4 py-3 backdrop-blur lg:hidden", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between gap-3", children: [(0, jsx_runtime_1.jsx)("div", { className: "flex min-w-0 flex-1 justify-center", children: (0, jsx_runtime_1.jsx)(image_1.default, { src: "/bravo-neuro-logo.svg", alt: "Bravo Neuro", width: 1289, height: 816, className: "h-12 w-full max-w-[11.5rem] object-contain object-center", priority: true }) }), (0, jsx_runtime_1.jsx)("span", { className: "rounded-full border border-emerald-300/65 bg-emerald-100/60 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-emerald-900", children: "Live" })] }), (0, jsx_runtime_1.jsx)("nav", { className: "-mx-1 mt-4 flex gap-2 overflow-x-auto px-1 pb-1", children: navItems.map((item) => ((0, jsx_runtime_1.jsx)(NavLink, { item: item, mobile: true, pathnameOverride: pathnameOverride }, item.href))) })] }), (0, jsx_runtime_1.jsx)("aside", { className: "hidden w-64 shrink-0 border-r border-border/90 bg-sidebar/96 lg:flex lg:h-screen lg:flex-col", children: (0, jsx_runtime_1.jsxs)("div", { className: "flex h-full flex-col px-5 py-6", children: [(0, jsx_runtime_1.jsx)("div", { className: "flex justify-center border-b border-border/90 pb-8", children: (0, jsx_runtime_1.jsx)(image_1.default, { src: "/bravo-neuro-logo.svg", alt: "Bravo Neuro", width: 1289, height: 816, className: "h-24 w-full max-w-[13.5rem] object-contain object-center", priority: true }) }), (0, jsx_runtime_1.jsx)("nav", { className: "mt-8 flex flex-1 flex-col gap-1.5", children: navItems.map((item) => ((0, jsx_runtime_1.jsx)(NavLink, { item: item, pathnameOverride: pathnameOverride }, item.href))) }), (0, jsx_runtime_1.jsxs)("div", { className: "border-t border-border/90 pt-5", children: [(0, jsx_runtime_1.jsxs)("div", { className: "rounded-3xl border border-emerald-300/70 bg-emerald-50/65 p-4 shadow-[0_14px_28px_-26px_rgba(5,150,105,0.18)]", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-[11px] font-semibold uppercase tracking-[0.18em] text-emerald-800", children: "Live snapshot" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-2 text-sm leading-6 text-emerald-950/85", children: "Overview, risk, actions, transfers, forecast, and branches stay in one branch context." })] }), (0, jsx_runtime_1.jsxs)("div", { className: "demo-card mt-4 p-4", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground", children: "Session" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-2 text-sm font-medium text-foreground", children: "Hackathon build" })] })] })] }) })] }));
}
